Set-Content -Path "src\pages\CustomersPage.jsx" -Encoding UTF8 -Value @'
...
# Update App.jsx to use real CustomersPage
$app = Get-Content "src\App.jsx" -Raw
$app = $app -replace 'import \{ CustomersPage, CreditsPage, TransfersPage, ExpenditurePage, ReportsPage \} from "\./pages/Placeholders";', 'import { CreditsPage, TransfersPage, ExpenditurePage, ReportsPage } from "./pages/Placeholders";
import CustomersPage from "./pages/CustomersPage";'
Set-Content "src\App.jsx" -Value $app -Encoding UTF8

Write-Host "Customers module done!" -ForegroundColor Green
