Set-Content -Path "src\pages\ReportsPage.jsx" -Encoding UTF8 -Value @'
...
$app = $app -replace 'import \{ ReportsPage \} from "\./pages/Placeholders";', 'import ReportsPage from "./pages/ReportsPage";'
Set-Content "src\App.jsx" -Value $app -Encoding UTF8

Write-Host "Reports page done!" -ForegroundColor Green
