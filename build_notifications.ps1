# Add notifications bell to Layout and create notifications dropdown

$layout = Get-Content "src\components\common\Layout.jsx" -Raw

# Add notifications bell in the main area header
# We'll add it as a floating bell in the top right of the main content
...
$layout = $layout -replace '      <main style=\{ \{ flex: 1, overflowY: "auto", background: "var\(--bg-base\)" \} \}>
        <Outlet />
      </main>', $newMain

# Add NotificationBell component at the end
$bellComponent = @'
...
Set-Content "src\components\common\Layout.jsx" -Value $layout -Encoding UTF8

Write-Host "Layout updated" -ForegroundColor Green

# Create a proper notifications component directly in Layout
...
Write-Host "Notifications bell added to Layout!" -ForegroundColor Green
