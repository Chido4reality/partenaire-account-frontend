# Add Staff Management tab to Settings and Notifications page

# Update SettingsPage to add Staff tab
$settings = Get-Content "src\pages\SettingsPage.jsx" -Raw

# Add staff tab to TABS array
$settings = $settings -replace "  const TABS = \[
...
Set-Content "src\pages\SettingsPage.jsx" -Value $settings -Encoding UTF8

# Append staff section to SettingsPage
$staffCode = @'

// Staff tab - append this inside SettingsPage component after account tab closing
'@

# Rewrite SettingsPage completely with staff tab included
...
Write-Host "Settings with Staff tab done!" -ForegroundColor Green
