# Fix navigation to include Settings
# Run from: C:\Users\Admin\Desktop\partenaire_account\frontend
...
# Update App.jsx to use real SettingsPage
$app = Get-Content "src\App.jsx" -Raw
if ($app -notmatch "import SettingsPage from") {
    $app = $app -replace 'import \{ CustomersPage, CreditsPage, TransfersPage, ExpenditurePage, ReportsPage, SettingsPage \} from "\./pages/Placeholders";', 'import { CustomersPage, CreditsPage, TransfersPage, ExpenditurePage, ReportsPage } from "./pages/Placeholders";
import SettingsPage from "./pages/SettingsPage";'
    Set-Content "src\App.jsx" -Value $app -Encoding UTF8
}

Write-Host "Settings added to navigation!" -ForegroundColor Green
