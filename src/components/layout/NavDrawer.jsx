...
const SECTIONS = [
  ...
  { en: "INVENTORY",  fr: "INVENTAIRE",        routes: ["/inventory", "/stock-count", "/barcodes", "/transfers", "/stock-check", "/restock", "/goods-buffer", "/dozie-listings", "/dozie-orders", "/dozie-messages", "/dozie-disputes"] },
